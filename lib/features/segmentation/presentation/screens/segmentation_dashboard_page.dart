...
import '../components/cluster_card.dart';
import '../components/filter_bar.dart';
import '../components/metric_tile.dart';
import '../components/segmentation_search_box.dart';
        ...
        appBar: AppBar(
          ...
          actions: [
            ...
            IconButton(
              ...
              onPressed: () =>
                  Navigator.pushNamed(context, AppScreen.secureVault.route),
              icon: const Icon(
                Icons.lock_outline,
                  ...
                  child: ListView(
                    ...
                    children: [
                      ...
                      FilterBar(
                        ...
                        onProfileChanged: (value) => provider.changeProfile(
                          value,
                          role: auth.user?.role,
                        ),
                        onProgramChanged: (value) => provider.changeProgram(
                          value,
                          role: auth.user?.role,
                        ),
                      ),
